...
def Dock(host_system,  monomer, number_of_host=1, number_of_monomers=1, number_of_complexes=1, energy=True, seed=None):
    """
    ...
    Edit: 19 September 2025, by Adriana Ugarte
    Addition of random seed for reproducibility 
    random_seed: int, optional 
    """
    # ---- SEED INITIALIZATION FOR REPRODUCIBILITY ---- # Adriana Ugarte
    if seed is not None:
